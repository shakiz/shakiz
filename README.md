...
⚙️ I work on `.java`, `.dart`, `.kt` and `.ts`<br />
🔭 I’m currently working on Mobile Application Development (Android Native with Kotlin, Jetpack Compose and Flutter) and Web Technologies(Next.js, Nuxt).<br/>
🌱 I’m currently working on shaping mobile app development alongside contribution to agentic development.<br/>
👯 I’m looking to collaborate on any kind to open source project related to the field of software engineering.<br/><br/>
<p align="start">
  <img src="https://github-readme-stats-fast.vercel.app/api/streak?username=shakiz&theme=radical" alt="Sakhawat's Contributions" height="170" />
</p>

### 📔 Recent Blog posts
<!-- BLOG-POST-LIST:START -->
- [XML to Jetpack Compose + Navigation 2]([https://medium.com/@shakilbd/compose-essentials-561ce949535f](https://medium.com/@shakilbd/how-we-migrated-a-production-android-app-from-xml-to-jetpack-compose-navigation-2-step-by-step-0082ca94d3ad))
